...
//        no_states=std::move(other.no_states);
//        no_control_inputs=std::move(other.no_control_inputs);
//        no_outputs=std::move(other.no_outputs);
//        no_transitions=std::move(other.no_transitions);
//
//        other.no_states=0;
//        other.no_control_inputs=0;
//        other.no_outputs=0;
//        other.no_transitions=0;
//
//        return *this;
//    }
    /* copy constructor */
...
//    Component& operator=(const Component&) = delete;
    ...
    Component(const string& filename) {
        int result = readMemberFromFile<abs_type>(filename, no_states, "NO_STATES");
        result = readMemberFromFile<abs_type>(filename, no_control_inputs, "NO_CONTROL_INPUTS");
        result = readMemberFromFile<abs_type>(filename, no_dist_inputs, "NO_DIST_INPUTS");
        result = readMemberFromFile<abs_type>(filename, no_outputs, "NO_OUTPUTS");
...
//        result = readMemberFromFile<abs_ptr_type>(filename, no_transitions, "NO_TRANSITIONS");
    }
};
